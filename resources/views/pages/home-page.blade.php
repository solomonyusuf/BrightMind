<div>
    <header class="section-home-hero">
                <div class="section-padding padding-verticle-170x100">
                    <div class="w-layout-blockcontainer container w-container">
                        <div class="section-inner home-hero">
                            <div class="hero-title-wrapper">
                                <h1 data-w-id="3890ca91-efae-9dba-0fa5-1d2d72b21da8"
                            ...
                            <div data-w-id="22bcecd8-91ae-ed40-a968-67856c9cfa20"
                                style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); opacity: 1; transform-style: preserve-3d;"
                                class="two-button-wrapper home-hero">
                                <a data-w-id="0c132085-8747-27c3-c654-073ae9ad4313" href="{{ asset('login') }}"
                                    class="button-secondary w-inline-block">
                                    <div>Get Started </div>
                                </a></div>
                            <div class="hero-vector-wrapper"><img
                                    src="https://cdn.prod.website-files.com/67ae25e5b332f13dff9ebd8d/67af701a55a8f4a32f888fc6_Hero%20Vactor.avif"
                                    loading="lazy"
                                    ...
                                    data-w-id="7d70a5c8-fdbf-e269-2ce8-0a38a1912521" alt="Hero Vactor"
                                    class="hero-vactor left-top"><img
                                    src="https://cdn.prod.website-files.com/67ae25e5b332f13dff9ebd8d/67af701acb74e60e725c6099_Hero%20Vactor%203.avif"
                                    loading="lazy"
                                    style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"
                                    data-w-id="b83dd7d7-2319-f654-0010-d0b9c9415a73" alt="Hero Vactor"
                                    class="hero-vactor right-top"><img
                                    src="https://cdn.prod.website-files.com/67ae25e5b332f13dff9ebd8d/67af701a0c7172a8f2f36af9_Hero%20Vactor%202.avif"
                                    loading="lazy"
                                    style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"
                                    data-w-id="5b865ba6-1730-eda2-0106-f68fad69f7cd" alt="Hero Vactor"
                                    class="hero-vactor left-bottom"><img
                                    src="https://cdn.prod.website-files.com/67ae25e5b332f13dff9ebd8d/67af701a7fe66816db9422cd_Hero%20Vactor%204.avif"
                                    loading="lazy"
                                    style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"
                                    data-w-id="e147b6ac-d28e-4b15-1718-b17f4a2cdc7d" alt="Hero Vactor"
                                    class="hero-vactor right-bottom"></div>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="section-padding">
                    <div class="w-layout-blockcontainer container w-container">
                        <div class="section-inner cta">
                            <h2 data-w-id="a10f8fb4-3697-b3cf-684c-67849576ee34" class="text-white cta-title"
                                ...
                                Take the First Step – Start Learning Today!</h2>
                            <div data-w-id="a10f8fb4-3697-b3cf-684c-67849576ee36" class="button-wrapper index-first"
                                style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d; opacity: 1;">
                                <a data-w-id="881c1e22-3960-58d6-05f1-6fefcedc5409" href="{{ asset('login') }}"
                                    class="button-primary white-button w-inline-block">
                                    <div>Get Started</div>
                                </a>
                            </div>
                        </div>
